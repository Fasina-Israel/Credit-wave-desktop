                                ...
                                <div className="input-section">
                                    <div className="first-section">
                                        <div className="company-email">
                                            <p style={{ color: 'black', lineHeight: '0px' }}>Number of Students admitted in the Oast</p>
                                            <Field
                                ...
                                <div style={{ height: '60px', justifyContent: 'flex-end', display: 'flex', gap: '5px', marginLeft: '30%', width: '78.7%' }}>
                                    ...
                                    <Button
                                        ...
                                        onClick={() => {
                                            ...
                                            updateForm({ ...initialFormValue, step4: values, currentStep: 'step3' });
                                        }}
                                        sx={{
                                            width: '10rem',
                                            fontWeight: 900,
