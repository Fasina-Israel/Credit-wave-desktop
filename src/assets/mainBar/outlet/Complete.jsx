...
const Complete = () => {
    ...
    return (
        <div className="outlet">
            ...
            >
                <div>
                    <h3 style={{ marginBottom: '20px' }}>{`${greet} ${'Israel'}`}</h3>
                ...
                <div className="" style={{ columnGap: '15px', display: 'flex', marginTop: '15px' }}>
                    ...
                    <div style={{ marginTop: '10px', marginLeft: '20px', width: '20rem', display: 'flex', flexDirection: 'row', marginTop: '10px' }}><div style={{ fontWeight: 'bold' }}>{`${'ala'}'s \u00A0 `}</div> registration is incomplete</div>
            ...
            >
                <div style={{
                    ...
                    <CompleteRegistration handleClose={handleClose} />
                </div>
            </Modal >
        </div >
    );
